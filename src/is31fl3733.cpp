...
#ifdef ENABLE_ABM
void IS31FL3733::SetLEDMode(uint8_t cs, uint8_t sw, IS31FL3733_LED_MODE mode)
{
  uint8_t offset;
...
void IS31FL3733::ConfigABM(IS31FL3733_ABM_NUM n, IS31FL3733_ABM *config)
{
